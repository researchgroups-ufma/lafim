...
// Ordem de exibição dos grupos na página — valores PT do frontmatter
const GROUP_ORDER = [
  "Pesquisador Sênior",
  "Pós-Doutorando",
  "Doutorando",
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-primary)", marginBottom: "1.25rem" }}>
                    {dict.members.coordinatorRole} · {siteConfig.acronym}
                  </p>
